...
// uiToken.ts — design-system compatible tokens
// These are kept as Tailwind strings where safe, pure strings otherwise.
// Components that use TEXT_GLOW, FILTER_GLOW_LINE, GLOW_LINE via className
// have been updated to inline styles directly, so these can be empty strings.

export const GLASS = "border border-border bg-accent";
export const GLASS_DEEP = "border border-border bg-accent backdrop-blur-xl";
...
// TEXT_GLOW — just white text, used in OutfitPieceCard (now inline styled)
export const TEXT_GLOW = "";

export const GLASS_PANEL = "relative rounded-2xl border border-border bg-card shadow-lg";
export const GLASS_INPUT = "fai-input";
