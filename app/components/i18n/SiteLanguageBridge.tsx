...
const PT_TRANSLATIONS: Record<string, string> = {
  ...
  'You are viewing this creator profile in read-only mode.': 'Você está visualizando este perfil em modo somente leitura.',
  'Edit your profile identity and public creator metadata.': 'Edite sua identidade de perfil e metadados públicos do criador.',
  ...
  'Card description override (optional)': 'Descrição do card (opcional)',
  'Palette (e.g. Blue / Neutral)': 'Paleta (ex: Azul / Neutro)',
  'Mood / aesthetic': 'Mood / estética',
  'SELECTION Default Brand': 'Marca padrão',
  'Abrir Estúdio de Fundo': 'Abrir Estúdio de Fundo',
  'Hero image upload': 'Imagem principal (upload)',
  'Uploading image...': 'Enviando imagem...',
  'Hero image uploaded successfully.': 'Imagem principal enviada com sucesso.',
  'Upload a photo of the person wearing the outfit.': 'Envie uma foto da pessoa usando o look.',
  'upper piece': 'peça superior',
  'lower piece': 'peça inferior',
  'shoes piece': 'calçado',
  'accessory piece': 'acessório',
  'No wardrobe item': 'Sem item do guarda-roupa',
  'From wardrobe': 'Do guarda-roupa',
  'Suggested options': 'Opções sugeridas',
  'Interpreting...': 'Interpretando...',
  'Interpretar look': 'Interpretar look',
  'Set as AI Mode': 'Definir como Modo IA',
  'Structured interpretation': 'Interpretação estruturada',
  'AI generation failed': 'Geração IA falhou',
  'Composition status:': 'Status da composição:',
  'of 4 slots filled': 'de 4 slots preenchidos',
  'Save Outfit Card': 'Salvar Card de Look',
  'Generate Outfit Card': 'Gerar Card de Look',
  'Generated Outfit Card': 'Card de Look Gerado',
  'Rendered after the final save & generate action.': 'Renderizado após salvar e gerar.',
  'Final preview, validation, and generation confirmation.': 'Pré-visualização final, validação e confirmação de geração.',
  'Quality check warning: title, style, occasion, and at least one slot are required before saving.': 'Aviso: título, estilo, ocasião e pelo menos um slot são obrigatórios antes de salvar.',
  'Define metadata, description behavior, and slot assignment manually.': 'Defina metadados, comportamento de descrição e atribuição de slots manualmente.',
  'Loadout-style review for each slot with completeness feedback.': 'Revisão estilo loadout de cada slot com feedback de completude.',
  'A IA sugere combinações com base nos seus itens e metadata.': 'A IA sugere combinações com base nos seus itens e metadados.',
  'Create a premium casual daily outfit with a visual anchor in blue tones.': 'Crie um look casual premium diário com âncora visual em tons azuis.',
  'Background': 'Fundo',
  ...
  'View Details': 'Ver Detalhes',
  'Use in Dress Tester': 'Usar no Provador 2D',
  'Usar no Provador 2D': 'Usar no Provador 2D',
  'Excluir peça': 'Excluir peça',
  'Fechar': 'Fechar',
  'Excluir': 'Excluir',
  'Excluindo…': 'Excluindo…',
  'Cancelar': 'Cancelar',
  'Nenhuma peça encontrada ainda.': 'Nenhuma peça encontrada ainda.',

  // Settings section
  'Cor dos elementos': 'Cor dos elementos',
  'Cor sólida': 'Cor dos elementos',
  ...
  // My Schemes section
  'Cards de look criados por você com visualização premium compacta.': 'Cards de look criados por você com visualização premium compacta.',
  'Nenhum esquema criado ainda.': 'Nenhum esquema criado ainda.',
  'Abrir': 'Abrir',
  'Editar': 'Editar',
  'Exportar': 'Exportar',

  // Misc
  'Meu Guarda-roupa': 'Meu Guarda-roupa',
  'Visualize e gerencie suas peças com cards premium compactos.': 'Visualize e gerencie suas peças com cards premium compactos.',
  'Back': 'Voltar',
  'Next': 'Próximo',
  'Or': 'Ou',
  'and': 'e',
