...
export default function OutfitPieceCard({ piece, compact = false, onOpenInDressTester, onViewPieceCard }: OutfitPieceCardProps) {
  ...
  const likes = (piece.likes ?? 0) + (liked ? 1 : 0);
