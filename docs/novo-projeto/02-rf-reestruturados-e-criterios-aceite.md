...
| 4 | **RF5.CA07b** | RF5 | Na **etapa 3** (formulário de geração manual — o antigo *Build Outfit*), cada lista (uma por parte do corpo) é um **espelho do guarda-roupa real do usuário** — só as peças que ele possui hoje, respeitando o estado *indisponível* (RF31.CA02). Hoje as listas trazem uma variedade fictícia |
