# RF32 — Desafios & Games do Guarda-Roupa
...
|---|---|---|
| Destaques (RF29) | olha para trás | "O que o meu guarda-roupa é e como evoluiu?" |
| **Desafios (RF32)** | olha para frente | "O que vou fazer com ele nesta semana?" |
...
| `CHANEL_WEEK` | **Semana Chanel** | todo dia, aplicar "Tira uma coisa" (RF28) no look | 7 dias | ✅ | ✅ | — | — | Identidade |
...
- **Conquistas secretas** (RF29 §4.3 e [`04`](04-detalhes-de-engajamento.md)): se estivessem numa lista, deixariam de ser secretas.
...
| Evidência | Fonte |
|---|---|
| look montado | esquema criado (RF5/RF28) com as regras do §5 de [`02-inventory-score-calculo.md`](02-inventory-score-calculo.md): ≥ 2 peças e sobrevivência de 24 h |
...
| Desafio ativo | O que aparece no Meu Quarto (RF27) |
|---|---|
...
| Integração | Regra |
|---|---|
| Destaques (RF29) | sugere até 2 desafios para as dimensões mais fracas do score |
...
| RF32.CA08 | duelo votado | um look é exibido para votação | marca, preço e autor ficam ocultos até o resultado ser publicado |
| RF32.CA09 | participante de equipe ou duelo | acessa o desafio | vê apenas os looks que cada membro publicou no desafio, **nunca** o guarda-roupa dos outros (**RNF6**) |
| RF32.CA10 | desafio ativo | o usuário cria um look ou registra um Look do Dia | o progresso é atualizado a partir do dado real (§4). Não existe botão "marcar como feito" |
| RF32.CA11 | participante sai de um desafio cooperativo | confirma a saída | a meta da equipe é recalculada com os membros restantes, e nenhum membro recebe notificação de culpa |
| RF32.CA12 | desafio concluído | o prazo acaba ou a meta é atingida | a recompensa é lançada no ledger de forma idempotente (RF30.CA01) e é gerado um card de resultado compartilhável |
...
| Fase | Escopo |
|---|---|
| **3a** (junto com a gamificação do RF30) | sub-aba, catálogo, modo **Solo** para 10×10, Segunda Chance, Sem Repetir e Semana Chanel. Progresso verificável. Representação no quarto |
