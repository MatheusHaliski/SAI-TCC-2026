    ...
    async generateModelFromImage(imageUrl, options) {
        ...
        for(let poll = 0; poll < MODEL_GENERATION_MAX_POLLS; poll += 1){
            ...
            if (status.status === 'failed' || status.status === 'cancelled') {
                const rawError = status.raw?.error && typeof status.raw.error === 'object' ? status.raw.error : null;
                ...
                const failedStage = isMeshyError ? meshyStageMap[workerCode] ?? 'meshy_submit' : 'runpod_worker_failure';
                const isAuthError = workerCode.includes('auth');
                const isMisconfigured = workerCode === 'meshy_endpoint_misconfigured';
                throw Object.assign(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$backend$2f$services$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ServiceError"](fullMessage, 502), {
                    pipelineFailure: {
                        failedStage,
                        provider: 'runpod',
                        errorCode: workerCode.toUpperCase() || 'WORKER_FAILED',
                        hint: rawError ? String(rawError.details?.hint ?? rawError.message ?? details) : fullMessage,
        ...
        throw Object.assign(new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$backend$2f$services$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ServiceError"]('3D generation is still running. Continue polling.', 202), {
            pipelineFailure: {
                ...
                retryable: true,
                diagnostics: {
                    cloudJobId: submitted?.cloudJobId ?? null
                }
            }
        });
    }
