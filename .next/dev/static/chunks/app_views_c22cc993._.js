...
function MyWardrobeView() {
    ...
    const handleOpenViewerIntent = async (item)=>{
        ...
        if (isInFlight) {
            ...
            try {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$blenderWorkerClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reconcileBlenderWorkerJob"])(item.wardrobe_item_id, cloudJobId);
                ...
                if (resultStatus === 'processing') {
                    await assetJob.startJob({
                        ...
                        pollJob: async (jobId)=>{
                            const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$blenderWorkerClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reconcileBlenderWorkerJob"])(item.wardrobe_item_id, jobId);
...
function DressTesterView() {
    ...
    const [selectedPieceId, setSelectedPieceId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [processingPieceId, setProcessingPieceId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [stageImageUrl, setStageImageUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [stageError, setStageError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [tryOnCache, setTryOnCache] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const mannequinImageAbsoluteUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DressTesterView.useMemo[mannequinImageAbsoluteUrl]": ()=>{
    ...
    const refreshData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DressTesterView.useCallback[refreshData]": async ()=>{
            ...
            const mapped = (payload.pieces ?? []).map({
                "DressTesterView.useCallback[refreshData].mapped": (piece)=>({
            ...
            }["DressTesterView.useCallback[refreshData].mapped"]);
            setPieces(mapped);
            setTryOnCache({
                "DressTesterView.useCallback[refreshData]": (prev)=>{
                    const next = {
                        ...prev
                    };
    ...
    const runTryOn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DressTesterView.useCallback[runTryOn]": async (piece)=>{
            ...
            setTryOnCache({
                "DressTesterView.useCallback[runTryOn]": (prev)=>({
                        ...prev,
                        [cacheKey]: payload.resultImageUrl
                    })
            }["DressTesterView.useCallback[runTryOn]"]);
        }
    }["DressTesterView.useCallback[runTryOn]"], [
        mannequin,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$shared$2f$SectionBlock$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        children: selectedPieceId && stageImageUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    processingPieceId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DressTesterView, "j8wtqJW7HXh/9cj5i4bYY8EjVd0=");
_c = DressTesterView;
var _c;
...
function AddWardrobeItemView({ mode = 'page', onPieceCreated }) {
    ...
    const [pendingTryOnPrewarm, setPendingTryOnPrewarm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
...
_s(AddWardrobeItemView, "cGZdQ7NXakjrXln7pvKgj9tJvmU=");
