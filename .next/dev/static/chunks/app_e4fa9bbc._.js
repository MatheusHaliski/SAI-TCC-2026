...
"[project]/app/lib/stylist-shell.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/pageBackground.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const readPageBackgroundConfig = ()=>{
    const raw = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$SafeStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLS"])(PAGE_BACKGROUND_KEY);
...
const savePageBackgroundConfig = (config)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$SafeStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setLS"])(PAGE_BACKGROUND_KEY, JSON.stringify(normalized));
...
"[project]/app/lib/theme.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/clientSession.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/semantic-badge-tokens.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/outfit-card.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/uiToken.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/fabricTextureRenderer.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/materialPresets.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/artwork-studio.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/outfit-piece-options.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/outfit-ai-mapping.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeDetectedPieceType(value) {
    ...
    const slot = Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$outfit$2d$piece$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLOT_TYPE_ALIASES"]).find((key)=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$outfit$2d$piece$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLOT_TYPE_ALIASES"][key].some((alias)=>normalized.includes(alias)));
    if (slot) return slot;
    for (const [slotKey, options] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$outfit$2d$piece$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OUTFIT_PIECE_OPTIONS"])){
...
function normalizeDetectedColor(value) {
    if (!value) return null;
    return detectByDictionary(value, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$outfit$2d$piece$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLOR_SYNONYMS"]);
}
function normalizeDetectedMaterial(value) {
    if (!value) return null;
    return detectByDictionary(value, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$outfit$2d$piece$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATERIAL_SYNONYMS"]);
}
...
function buildOutfitCardDraftFromPrompt(prompt) {
    ...
    const detectedItems = [];
    for (const [slot, options] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$outfit$2d$piece$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OUTFIT_PIECE_OPTIONS"])){
    ...
    return {
        ...
        detectedStyleTags: normalizeTagList(tokens, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$outfit$2d$piece$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STYLE_TAG_SYNONYMS"]),
        detectedOccasionTags: normalizeTagList(tokens, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$outfit$2d$piece$2d$options$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OCCASION_TAG_SYNONYMS"]),
...
"[project]/app/lib/wardrobeModelUrl.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/fashion-ai/utils/garment-compatibility.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/fashion-ai/services/MannequinFitService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MannequinFitService {
    buildFittedGarmentLayer(args) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$fashion$2d$ai$2f$utils$2f$garment$2d$compatibility$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isPieceCompatibleWithMannequin"])(fitProfile, mannequin.id, mannequin)) {
...
"[project]/app/lib/fashion-ai/services/Tester2DRenderService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$fashion$2d$ai$2f$services$2f$MannequinFitService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/fashion-ai/services/MannequinFitService.ts [app-client] (ecmascript)");
;
const slotOrder = [
    'full_body',
    'top',
...
class Tester2DRenderService {
    fitService;
    constructor(fitService = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$fashion$2d$ai$2f$services$2f$MannequinFitService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MannequinFitService"]()){
...
"[project]/app/lib/devSession.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getDevSessionToken = ()=>{
    const parsed = parseExpiringToken((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$SafeStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLS"])(DEV_SESSION_TOKEN_KEY));
    if (!parsed) return "";
    if (parsed.expiresAt <= Date.now()) {
        clearDevSessionToken();
        return "";
    }
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$SafeStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setLS"])(DEV_SESSION_TOKEN_KEY, JSON.stringify(parsed));
    return parsed.token;
};
const setDevSessionToken = (token)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$SafeStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setLS"])(DEV_SESSION_TOKEN_KEY, JSON.stringify(payload));
};
const clearDevSessionToken = ()=>{
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$SafeStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeLS"])(DEV_SESSION_TOKEN_KEY);
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/lib/dress-tester-models.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/hooks/useProfileUpdate.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(useProfileUpdate, "0K8eBGVvpQgvVovMtmEl4r5w8Xk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/hooks/useOutfitExport.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(useOutfitExport, "w831ZXNpNPeUBKV0zr4u2iKSLuA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/hooks/use3dAssetJob.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function use3dAssetJob(options) {
    ...
    const [artifactUrl, setArtifactUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [pollAttempts, setPollAttempts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const pollTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const absoluteTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const activeJobRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const pollJobRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const attemptsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const transientFailuresRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const MAX_TRANSIENT_FAILURES = 3;
    const stopTimers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "use3dAssetJob.useCallback[stopTimers]": ()=>{
    ...
    const completeWithArtifact = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "use3dAssetJob.useCallback[completeWithArtifact]": (url)=>{
            stopTimers();
            setArtifactUrl(url);
            setStatus('completed');
    ...
    }["use3dAssetJob.useCallback[completeWithArtifact]"], [
        options,
        stopTimers
    ]);
    const failJob = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "use3dAssetJob.useCallback[failJob]": (nextStatus, message)=>{
            stopTimers();
            setStatus(nextStatus);
            setError(message);
            setProgressPercent({
                "use3dAssetJob.useCallback[failJob]": (current)=>Math.max(10, Math.min(99, current))
            }["use3dAssetJob.useCallback[failJob]"]);
        }
    }["use3dAssetJob.useCallback[failJob]"], [
        stopTimers
    ]);
    const schedulePoll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "use3dAssetJob.useCallback[schedulePoll]": (execute, attempt)=>{
            const interval = Math.min(maxPollIntervalMs, Math.round(basePollIntervalMs * Math.pow(1.25, Math.max(0, attempt - 1))));
            pollTimeoutRef.current = window.setTimeout({
                "use3dAssetJob.useCallback[schedulePoll]": ()=>{
                    void execute();
                }
            }["use3dAssetJob.useCallback[schedulePoll]"], interval);
        }
    }["use3dAssetJob.useCallback[schedulePoll]"], [
        basePollIntervalMs,
        maxPollIntervalMs
    ...
    const startPolling = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "use3dAssetJob.useCallback[startPolling]": (nextJobId, pollJob)=>{
            stopTimers();
            ...
            absoluteTimeoutRef.current = window.setTimeout({
                "use3dAssetJob.useCallback[startPolling]": ()=>{
                    failJob('timed_out', '3D generation timed out. Please retry.');
                }
            }["use3dAssetJob.useCallback[startPolling]"], timeoutMs);
            const runPoll = {
                "use3dAssetJob.useCallback[startPolling].runPoll": async ()=>{
                    ...
                    try {
                        ...
                        setStatus(nextStatus);
                        setProgressPercent({
                            "use3dAssetJob.useCallback[startPolling].runPoll": (current)=>{
                                if (nextStatus === 'queued') {
                                    return Math.min(65, Math.max(15, current + 4));
                                }
                                return Math.min(95, Math.max(35, current + 5));
                            }
                        }["use3dAssetJob.useCallback[startPolling].runPoll"]);
    ...
    const startJob = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "use3dAssetJob.useCallback[startJob]": async (input)=>{
            setError(null);
            setArtifactUrl(null);
    ...
    }["use3dAssetJob.useCallback[startJob]"], [
        completeWithArtifact,
        failJob,
        startPolling
    ]);
    const cancelPolling = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "use3dAssetJob.useCallback[cancelPolling]": ()=>{
            stopTimers();
    ...
    const retry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "use3dAssetJob.useCallback[retry]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "use3dAssetJob.useEffect": ()=>({
                "use3dAssetJob.useEffect": ()=>stopTimers()
            })["use3dAssetJob.useEffect"]
    }["use3dAssetJob.useEffect"], [
        stopTimers
    ]);
...
_s(use3dAssetJob, "WkYZMeCn/QRbk93vkqDX0frDzes=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/services/Tester2DAssetResolver.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/services/blenderWorkerClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=app_e4fa9bbc._.js.map